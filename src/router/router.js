...
const registry = r => require.ensure([], () => r(require('../frames/me/settings/detailset/registry')), 'registry')
const before = r => require.ensure([], () => r(require('../frames/me/settings/detailset/before')), 'before')
const face = r => require.ensure([], () => r(require('../frames/conversation/chatmessage/foot/index')), 'index')
const voice = r => require.ensure([], () => r(require('../frames/conversation/chatmessage/wechatfooter')), 'voice')
const qrcode = r => require.ensure([], () => r(require('../frames/me/settings/detailset/qrcode')), 'qrcode')
const saoyisao = r => require.ensure([], () => r(require('../frames/find/saoyisao')), 'saoyisao')
const yaoyiyao = r => require.ensure([], () => r(require('../frames/find/yaoyiyao')), 'yaoyiyao')
// 商城路由配置
export default [{
  path: '/',
  component: App,
  children: [
    // /before
    {path: '', redirect: '/find'},   //地址为空时跳转dialogue页面
    {path: '/dialogue', component: dialogue},//对话列表页
    {path: '/login', component: login},//对话列表页
    {path: '/registry', component: registry},
    {path: '/before', component: before},
    {path: '/voice', component: voice},
    {path: '/qrcode', component: qrcode},
    {path: '/saoyisao', component: saoyisao},
    {path: '/yaoyiyao', component: yaoyiyao},
    {
      path: '/singlechat/:id',
