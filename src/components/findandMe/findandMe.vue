<template>
  <section>
    <section class="find">
      <router-link :to="$route.path.indexOf('find') !== -1 ? '/find/friendcircle' : '/me/personaldetails' "
                   class="findlist" @click.native="firendThing">
        <div class="find_wipe">
          <div class="findlist_left">
            ...
            <section class="me_name" v-if="pathUrl">
              <div>{{userInfo.pet_name}}</div>
              <div>微信号：{{userInfo.wx_id}}</div>
            </section>
            ...
            <section class="findlist_svg">
              <svg fill="#10aeff">
                <use xmlns:xlink="http://www.w3.org/1999/xlink"
                     :xlink:href=" pathUrl ? '#photo' : '#onesweeptwo'"></use>
              </svg>
            </section>

            <section class="findlist_text">
              <span v-if="pathUrl">相册</span>
              <span v-else><div @click="callAndroidQRCode">扫一扫</div></span>
            </section>
        ...
        <div class="find_wipe" @click="collect">
          <div class="findlist_left">
            ...
            <section class="findlist_text">
              ...
              <span v-else><router-link to="/yaoyiyao">摇一摇</router-link></span>
            </section>
          </div>
        </div>
      </section>
          ...
          <div class="findlist_left">
            <section class="findlist_svg">
              <svg data-v-38f704c5="" fill="#10aeff">
                <use data-v-38f704c5="" xmlns:xlink="http://www.w3.org/1999/xlink"
                     :xlink:href="pathUrl ? '#cardbag' : '#shopping'"></use>
              </svg>
            </section>
            <section class="findlist_text">
